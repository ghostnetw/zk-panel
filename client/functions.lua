...
AdminPanel.DeleteEntity = function(entity)    
    ...
    if ( DoesEntityExist( entity ) ) then 
        DeleteEntity(entity)
        if ( DoesEntityExist( entity ) ) then 
            TriggerEvent("zk-admin:client:ShowPanelAlert", "danger", "<strong>ERROR:</strong> Entity could not be deleted.")
            return false
        else 
            TriggerEvent("zk-admin:client:ShowPanelAlert", "success", "<strong>SUCCESS:</strong> Entity deleted.")
        end
    else 
        TriggerEvent("zk-admin:client:ShowPanelAlert", "success", "<strong>SUCCESS:</strong> Entity deleted.")
    end
